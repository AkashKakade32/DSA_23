...
class SinglyCircularLinkedList: 
    ...
    def getStart(self) -> int: 
        ...
        if self.headNode.next is self.headNode: 
    ...
    def getEnd(self) -> int: 
        ...
        run = self.headNode 
        while run.next is not self.headNode: 
            run = run.next 
    ...
    def removeStart(self): 
        ...
        self.headNode.next = firstNodeWithData.next
    ...
    def isEmpty(self) -> bool: 
        ...
        return self.headNode.next is self.headNode 
    ...
    def append(self, other): 
        if other.headNode.next is other.headNode: 
            del other.headNode 
            return None 
        
        lastNode = self.headNode 
        while lastNode.next is not self.headNode: 
            lastNode = lastNode.next 

        lastNodeOfOther = other.headNode 
        while lastNodeOfOther.next is not other.headNode: 
            lastNodeOfOther = lastNodeOfOther.next 

        lastNode.next = other.headNode.next 
        lastNodeOfOther.next = self.headNode 

        del other.headNode 
    

    def merge(self, other): 
        mergedList = SinglyCircularLinkedList() 
...
print('----P.merge(Q)----')
P = SinglyCircularLinkedList() 
Q = SinglyCircularLinkedList() 
